// /blog/js/ia-vs-bitcoin.js
// =========================
// NAV: Hamburguesa + link activo
// =========================
(function () {
  'use strict';
  if (window.__iaVsBitcoinMenuInit) return;
  window.__iaVsBitcoinMenuInit = true;
  ...
  if (btn && menu) {
    ...
    // Reset en desktop (≥768px) con fallback
...
// =========================
// ADS: Lazy push (IO + MO)
// Requiere el loader de AdSense en <head>
// =========================
(function () {
  'use strict';
  ...
  // Observa los <ins.adsbygoogle> existentes
